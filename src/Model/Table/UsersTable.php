 ...
 * @property \App\Model\Table\SignaturesTable&\Cake\ORM\Association\HasMany $Requests
...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->add('email', 'unique',
                ['rule' => 'validateUnique', 'provider' => 'table', 'message' => 'This email has been used. Please try with a different email or reset password']);
        ...
        $validator
            ->scalar('phone_mobile')
            ->lessThanOrEqual('phone_mobile',9999999999,"please enter the correct phone number in 10 digits")
        ...
        $validator
            ->scalar('phone_office')
            ->lessThanOrEqual('phone_office',9999999999,"please enter the correct phone number in 10 digits")
            ->maxLength('surveyor_phone', 10)
            ->minLength('surveyor_phone', 10)
        ...
        $validator
            ...
            ->lessThanOrEqual('emergency_phone',9999999999,"please enter the correct phone number in 10 digits")
            ->maxLength('surveyor_phone', 10)
            ->minLength('surveyor_phone', 10)
