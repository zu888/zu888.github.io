...
class DocumentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->add('file_upload', [
                'validExtension' => [
                    'rule' => ['extension', ['pdf','jpg','jpeg']],
                    'message' => 'Please only upload PDF/ JPEG/ JPG files'
                ]
            ]);

        $validator
            ->boolean('requires_signature')
            ->allowEmptyString('requires_signature');
        ...
        $validator
//            ->scalar('auth_value') //bug when auth_value = 3
//            ->maxLength('auth_value', 200)
        ...
        $validator
            ->scalar('document_relation')
            ->maxLength('document_relation', 20)
            ->requirePresence('document_relation', 'create')
            ->notEmptyString('document_relation');
