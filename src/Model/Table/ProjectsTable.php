...
class ProjectsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('permit_no')
            ->maxLength('permit_no', 50)
            ->requirePresence('permit_no', 'create')
            ->notEmptyString('permit_no');
        ...
        $validator
            ...
            ->minLength('client_email', 4)
            ->requirePresence('client_email', 'create')
            ->notEmptyString('client_email');

        $validator
            ->scalar('client_phone')
            ->lessThanOrEqual('client_phone',9999999999,"please enter the correct phone number in 10 digits")
        ...
        $validator
            ->scalar('surveyor_name')
            ->maxLength('surveyor_name', 50)
            ->requirePresence('surveyor_name', 'create')
            ->notEmptyString('surveyor_name');

        $validator
            ->scalar('surveyor_email')
            ->maxLength('surveyor_email', 320)
            ->requirePresence('surveyor_email', 'create')
            ->notEmptyString('surveyor_email');

        $validator
            ->scalar('surveyor_phone')
            ->lessThanOrEqual('surveyor_phone',9999999999,"please enter the correct phone number in 10 digits")
            ->maxLength('surveyor_phone', 10)
            ->minLength('surveyor_phone', 10)
            ->requirePresence('surveyor_phone', 'create')
            ->notEmptyString('surveyor_phone');
        $validator
            ->date('start_date')
        ...
        $validator
            ...
            ->numeric('address_postcode', "Please enter a valid postcode")
            ->maxLength('address_postcode', 4)
            ->minLength('address_postcode', 4)
