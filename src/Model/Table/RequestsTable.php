...
class RequestsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('request_text')
            ->maxLength('request_text', 250)
            ->requirePresence('request_text', 'create')
            ->notEmptyString('request_text');
        ...
        $validator
            ->nonNegativeInteger('removal_status')
            ->allowEmptyString('removal_status');
