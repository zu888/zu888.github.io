...
<div class="companies index content">
    ...
    <h3><?= __('My Subcontractors') ?></h3>

    <br>
    <br>
        <h4> Page Guide: </h4>
        <h5> On this page you will see all the subcontracted companies. </h5>
        <h5> You can view the company detail and disengage with them by anytime. </h5>
        <br>

    <?= $this->Html->link(__('Invite Company/Contractor'), ['controller' => 'Requests', 'action' => 'inviteCompanyToCompany', $company->id,], ['class' => 'btn btn-primary', 'style' => 'width: 200px']) ?>
