...
<div class="row content">
    <div class="column-responsive column-80">
        ...
        <div class="companies view">
            <h3><?= __('Incomplete Inductions') ?></h3>
            <?php if (!empty($uninducted)) : ?>
                <div class="table-responsive">
                    <table class="table table-bordered" style="background-color:ghostwhite; max-width:800px">
                        <tr>
                            <th><?= __('Role') ?></th>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?php if ($users->role != 'Administrator'){
                                        echo $this->Html->Link(__('Induct'), ['controller' => 'Companies', 'action' => 'pending', $company->id,
                                            '?' => ['inductUser' => $users->id]],
                                            ['confirm' => 'Induct '.$users->first_name.' '.$users->last_name.' into your company?']);
                                    } ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
